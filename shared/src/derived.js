import { UNITS, CLASSES, PACK, ROSTER } from "./constants.js";
import { ZONES, ZINFO, hexXY } from "./board.js";
...
export function qtyOf(k, p) { return Math.round(UNITS[k].qty * CLASSES[p.cls].costMul * packOf(k)); }
